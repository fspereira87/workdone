...
def main():
    ...
    print("Shape of labels before one-hot encoding:", np.array(labels).shape)
...
def load_data(data_dir):
    ...
    for foldername in os.listdir(data_dir):
        if not foldername.isdigit():
            print(f"Warning! Non-integer folder name '{foldername}' in data directory! Skipping...")
            continue
    ...
    #labels_one_hot = to_categorical(labels, num_classes=NUM_CATEGORIES)
